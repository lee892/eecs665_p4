...
#line 51 "jeff.yy"
   ...
   jeff::ArrayTypeNode *                transArrayType;
...
#line 253 "frontend.hh"
    ...
    Parser (jeff::Scanner &scanner_yyarg, jeff::ProgramNode** root_yyarg);
    virtual ~Parser ();
  ...
  private:
    ...
    enum
    {
      yylast_ = 559,     ///< Last index in yytable_.
    ...
    // User arguments.
    jeff::Scanner &scanner;
    jeff::ProgramNode** root;
