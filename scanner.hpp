...
public:
   ...
   void errIllegal(Position * pos, std::string match){
	jeff::Report::fatal(pos, "Illegal character "
		+ match);
   }

   void errStrEsc(Position * pos){
	jeff::Report::fatal(pos, "String literal with bad"
	" escape sequence ignored");
   }

   void errStrUnterm(Position * pos){
	jeff::Report::fatal(pos, "Unterminated string"
	" literal ignored");
   }

   void errStrEscAndUnterm(Position * pos){
	jeff::Report::fatal(pos, "Unterminated string literal"
